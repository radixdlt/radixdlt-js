...
//             expect(RadixSerializer.toByteArray(byteSerializerIn[i])).to.deep.equal(byteSerializerOut[i])
//         }
...
//         for (let i = 0; i < byteSerializerIn.length; i++) {
//             expect(RadixSerializer.fromByteArray(byteSerializerOut[i])).to.deep.equal(byteSerializerIn[i])
//         }
...
// byteSerializerOut[0] = Buffer.from([DataTypes.BOOLEAN, /**/ 0x00, 0x00, 0x00, 0x01,  /**/ 0x01])

// byteSerializerIn[1] = 0xFF
// byteSerializerOut[1] = Buffer.from([DataTypes.NUMBER, /**/ 0x00, 0x00, 0x00, 0x08,  /**/ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF])

// byteSerializerIn[2] = 'abc'
// byteSerializerOut[2] = Buffer.from([DataTypes.STRING, /**/ 0x00, 0x00, 0x00, 0x03,  /**/ 0x61, 0x62, 0x63])

// byteSerializerIn[3] = new RadixBASE64([1, 2, 3])
// byteSerializerOut[3] = Buffer.from([DataTypes.BYTES, /**/ 0x00, 0x00, 0x00, 0x03,  /**/ 0x1, 0x2, 0x3])
...
// const atom = RadixSerializer.fromJson(atomNotification.params.atoms[0]) as RadixNullAtom
