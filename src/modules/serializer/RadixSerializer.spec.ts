...
describe('Byte array serializer', () => {
    it('should serialize to a byte array', () => {
        for (let i = 0; i < byteSerializerIn.length; i++) {
            expect(
                RadixSerializer.toByteArray(byteSerializerIn[i])
            ).to.deep.equal(byteSerializerOut[i])
        }
    ...
    it('should deserialize from byte array', () => {
        for (let i = 0; i < byteSerializerIn.length; i++) {
            expect(
                RadixSerializer.fromByteArray(byteSerializerOut[i])
            ).to.deep.equal(byteSerializerIn[i])
        }
                    ...
                    vertices: [
                        {
                            owner: {
                                public: {
                                    serializer: 'BASE64',
                                    value:
                                        'AgNlNmZXIX+GY+A3rkYloQSrE0d1eF8YQcm3LwXZXC8/'
                                },
                            ...
                            signature: {
                                r: {
                                    serializer: 'BASE64',
                                    value:
                                        'AJrsc4oApyLtuP34VgB5RqREToGGku2z8H7ImD6WMcOV'
                                },
                                s: {
                                    serializer: 'BASE64',
                                    value:
                                        'X+o08bmzbY3DUBSxoQF7Y53Zcetm3R2lg4UXxKu1inQ='
                                },
                        ...
                        owners: [
                            {
                                public: {
                                    serializer: 'BASE64',
                                    value:
                                        'A8qiisybzYWGnThN2beJfSQMHAHRK0WEVAeV54/rTlGp'
                                },
                                serializer: 547221307,
                                version: 100
                            }
                        ...
                        owners: [
                            {
                                public: {
                                    serializer: 'BASE64',
                                    value:
                                        'A+ewE2b1wj4+qiYeyex9IHNoj7xwPbqBOcIT9vonfRq4'
                                },
                                serializer: 547221307,
                                version: 100
                            }
                ...
                signatures: {
                    '31655847435213307464496696616': {
                        r: {
                            serializer: 'BASE64',
                            value:
                                'AOnzxV1UWjUiAkOXQ05RknL5v4th+Rgb2rvgPwDpUJc='
                        },
                        s: {
                            serializer: 'BASE64',
                            value:
                                'YPrmc4DvOv2H9Wq54ywAg8sq5URAXwFugEJ2wL0fK1Q='
                        },
                        serializer: -434788200,
                        version: 100
                    }
