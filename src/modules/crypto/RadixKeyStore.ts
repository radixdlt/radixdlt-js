...
export default class RadixKeyStore {
    ...
    public static async storeKey(filePath: string, keyPair: RadixKeyPair, password: string) {
    ...
    public static async loadKey(filePath: string, password: string): Promise<RadixKeyPair> {
