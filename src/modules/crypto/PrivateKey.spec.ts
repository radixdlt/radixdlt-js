...
import { RadixAddress, RadixECSignature, radixHash, sha256ByUTF8EncodingText } from '../..'
    ...
    describe(`ECDSA signatures`, () => {
        describe('RFC6979', function() {
            ...
            const verifyRFC6979 = (
                ...
                const expectedSignatureFromDER = RadixECSignature.fromDER(expectedSignatureDERHex)

                expect(signature.equals(expectedSignatureFromDER)).to.be.true
            ...
            it(`should match expected test vectors`, () => {
