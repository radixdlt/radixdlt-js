...
export default class RadixUniverse {
   ...
   * @param config 
   */
  public bootstrap(config: {universeConfig: RadixUniverseConfig, nodeDiscovery: RadixNodeDiscovery, nodePort: number}) {
  ...
  private async openNodeConnection(shard: Long): Promise<RadixNodeConnection | null> {
