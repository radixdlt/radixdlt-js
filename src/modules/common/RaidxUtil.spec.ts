...
//         expect(RadixUtil.bigIntFromByteArray(ba3).toString()).to.equal(bi3.toString())
//         expect(RadixUtil.bigIntFromByteArray(ba4).toString()).to.equal(bi4.toString())
...
//        expect(RadixUtil.powTargetFromAtomSize(4)).to.deep.equal(Buffer.from('0FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF', 'hex'))
