...
export default class RadixNodeConnection {
    ...
    subscribe(address: RadixKeyPair, onNotification: Function, onClosed: Function) {
    ...
    sendAtom(atom: RadixAtom) {
        ...
        this._socket.call('Universe.submitAtomAndSubscribe', {
    ...
    public async getAtomById(id: RadixEUID) {
        //TODO
        return this._socket.call('Atoms.getAtomInfo', {id: id.toJson()})
        .then((response: any) => {
    ...
    private _onAtomReceivedNotification = (notification: AtomReceivedNotification) => {
        ...
        let deserializedAtoms = RadixSerializer.fromJson(notification.atoms) as Array<RadixAtom>
